"""Hash-based document verification API for Facts integration.

This module provides the integration layer between mcp-docs and mcp-facts,
...
def lookup_document_by_hash(
    ...
    Used by mcp-facts to resolve hash references to documents.
