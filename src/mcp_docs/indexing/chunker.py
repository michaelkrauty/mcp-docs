...
Philosophy: Leverage the full context window of large embedding models (32k tokens).
...
class DocumentChunker:
    ...
    def _chunk_by_paragraphs(
        ...
        for para in paragraphs:
            ...
            if current_content and len(current_content) + len(stripped) + 2 > self.max_chars:
                chunks.append(
                    DocumentChunk(
                        document_id=document_id,
                        chunk_index=chunk_index,
                ...
                current_content = overlap_text + stripped if overlap_text else stripped
            ...
            char_offset += len(stripped) + 2  # Include \n\n separator
